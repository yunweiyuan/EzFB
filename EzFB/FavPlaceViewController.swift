...
/******** here ********/
class FavPlaceViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
...
extension FavPlaceViewController {/******** here ********/
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "FavPlaceCell", for: indexPath) as! FavPlaceTableViewCell/******** here ********/
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let currentCell = tableView.cellForRow(at: indexPath)! as! FavPlaceTableViewCell/******** here ********/
        passId = currentCell.id!
        passName = (currentCell.record?.name)!
        passProfileImageURL = (currentCell.record?.imageURL)!
        self.tabBarController?.tabBar.isHidden = true
        performSegue(withIdentifier: "FavPlaceShowDetails", sender: nil)/******** here ********/
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "FavPlaceShowDetails" {/******** here ********/
