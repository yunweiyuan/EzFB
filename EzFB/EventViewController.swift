...
class EventViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func JSONFromURL(url: String) {
        ...
        Alamofire.request(newURL!).responseJSON{ response in
            ...
            self.eventJSON = json//********** here ************//
            self.getRecordFromJSON(json: self.eventJSON)//********** here ************//
        }
    }
    ...
    func fectchJSON(keyword: String, center: String) {
        ...
        Alamofire.request(url).responseJSON{ response in
            ...
            //print(json["user"])
            if(json["event"]["paging"]["previous"].exists()){//********** here ************//
                self.prevURL = json["event"]["paging"]["previous"].stringValue//********** here ************//
            }
            if(json["event"]["paging"]["next"].exists()){//********** here ************//
                self.nextURL = json["event"]["paging"]["next"].stringValue//********** here ************//
            }
            self.getRecordFromJSON(json: self.eventJSON)
        }
    }
...
extension EventViewController {            //********** here ************//
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "EventCell", for: indexPath) as! EventTableViewCell//********** here ************//
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let currentCell = tableView.cellForRow(at: indexPath)! as! EventTableViewCell//********** here ************//
        passId = currentCell.id!
        passName = (currentCell.record?.name)!
        passProfileImageURL = (currentCell.record?.imageURL)!
        self.tabBarController?.tabBar.isHidden = true
        performSegue(withIdentifier: "EventShowDetails", sender: nil)//********** here ************//
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "EventShowDetails" {//********** here ************//
