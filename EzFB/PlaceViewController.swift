...
class PlaceViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func JSONFromURL(url: String) {
        ...
        Alamofire.request(newURL!).responseJSON{ response in
            ...
            self.placeJSON = json//********** here ************//
            self.getRecordFromJSON(json: self.placeJSON)//********** here ************//
        }
    }
    ...
    func fectchJSON(keyword: String, center: String) {
        ...
        Alamofire.request(url).responseJSON{ response in
            ...
            //print(json["user"])
            if(json["place"]["paging"]["previous"].exists()){//********** here ************//
                self.prevURL = json["place"]["paging"]["previous"].stringValue//********** here ************//
            }
            if(json["place"]["paging"]["next"].exists()){//********** here ************//
                self.nextURL = json["place"]["paging"]["next"].stringValue//********** here ************//
            }
            self.getRecordFromJSON(json: self.placeJSON)
        }
    }
...
extension PlaceViewController {            //********** here ************//
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "PlaceCell", for: indexPath) as! PlaceTableViewCell//********** here ************//
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let currentCell = tableView.cellForRow(at: indexPath)! as! PlaceTableViewCell//********** here ************//
        passId = currentCell.id!
        passName = (currentCell.record?.name)!
        passProfileImageURL = (currentCell.record?.imageURL)!
        self.tabBarController?.tabBar.isHidden = true
        performSegue(withIdentifier: "PlaceShowDetails", sender: nil)//********** here ************//
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "PlaceShowDetails" {//********** here ************//
