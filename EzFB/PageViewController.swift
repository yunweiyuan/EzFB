...
class PageViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func JSONFromURL(url: String) {
        ...
        Alamofire.request(newURL!).responseJSON{ response in
            ...
            self.pageJSON = json//********** here ************//
            self.getRecordFromJSON(json: self.pageJSON)//********** here ************//
        }
    }
    ...
    func fectchJSON(keyword: String, center: String) {
        ...
        Alamofire.request(url).responseJSON{ response in
            ...
            //print(json["user"])
            if(json["page"]["paging"]["previous"].exists()){//********** here ************//
                self.prevURL = json["page"]["paging"]["previous"].stringValue//********** here ************//
            }
            if(json["page"]["paging"]["next"].exists()){//********** here ************//
                self.nextURL = json["page"]["paging"]["next"].stringValue//********** here ************//
            }
            self.getRecordFromJSON(json: self.pageJSON)
        }
    }
...
extension PageViewController {            //********** here ************//
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "PageCell", for: indexPath) as! PageTableViewCell//********** here ************//
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let currentCell = tableView.cellForRow(at: indexPath)! as! PageTableViewCell//********** here ************//
        passId = currentCell.id!
        passName = (currentCell.record?.name)!
        passProfileImageURL = (currentCell.record?.imageURL)!
        self.tabBarController?.tabBar.isHidden = true
        performSegue(withIdentifier: "PageShowDetails", sender: nil)//********** here ************//
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "PageShowDetails" {//********** here ************//
