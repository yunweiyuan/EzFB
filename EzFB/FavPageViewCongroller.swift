...
/******** here ********/
class FavPageViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
...
extension FavPageViewController {/******** here ********/
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "FavPageCell", for: indexPath) as! FavPageTableViewCell/******** here ********/
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let currentCell = tableView.cellForRow(at: indexPath)! as! FavPageTableViewCell/******** here ********/
        passId = currentCell.id!
        passName = (currentCell.record?.name)!
        passProfileImageURL = (currentCell.record?.imageURL)!
        self.tabBarController?.tabBar.isHidden = true
        performSegue(withIdentifier: "FavPageShowDetails", sender: nil)/******** here ********/
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "FavPageShowDetails" {/******** here ********/
