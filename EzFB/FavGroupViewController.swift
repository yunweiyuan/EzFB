...
/******** here ********/
class FavGroupViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
...
extension FavGroupViewController {/******** here ********/
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "FavGroupCell", for: indexPath) as! FavGroupTableViewCell/******** here ********/
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let currentCell = tableView.cellForRow(at: indexPath)! as! FavGroupTableViewCell/******** here ********/
        passId = currentCell.id!
        passName = (currentCell.record?.name)!
        passProfileImageURL = (currentCell.record?.imageURL)!
        self.tabBarController?.tabBar.isHidden = true
        performSegue(withIdentifier: "FavGroupShowDetails", sender: nil)/******** here ********/
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "FavGroupShowDetails" {/******** here ********/
